...
@section('content')
    ...
    <a href="./operator/create" class="btn btn-primary a-btn-slide-text">
    ...
    <table id='users' class="table table-bordered table-bordered">
        ...
        @foreach($operators as $u)
            <tr>
                <td>{{$u->name}}</td>
                <td>
                    <img class="img-responsive img-rounded" src="./operators/{{$u->image}}"
                ...
                @endif
                <td>
                    <a title="edit" href='./operator/{{$u->id}}/edit'  class="btn btn-warning a-btn-slide-text" style="color:white;">
                        <span class="fa fa-edit" aria-hidden="true"></span>
                    </a>
                    <a title="Delete" href='./operator/delete/{{$u->id}}'  onclick="return confirm('Are you sure you want to delete this employee?')" class="btn btn-danger a-btn-slide-text">
