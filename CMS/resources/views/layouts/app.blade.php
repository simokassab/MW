<?php
define('SITE_URL', 'http://' . $_SERVER['SERVER_NAME'] . '/mediaworld/CMS/public/'); ?>
<!doctype html>
...
<head>
    ...
    <style>
        ...
        .btn-danger {
            background-color: #E22747 !important;
            border-color: #E22747 !important;
        }
        ...
        .btn-warning {
            background-color: #4D8869 !important;
            border-color: #4D8869 !important;
        }
        ...
        .btn-info {
            background-color: #8F539F !important;
            border-color: #8F539F !important;
        }
